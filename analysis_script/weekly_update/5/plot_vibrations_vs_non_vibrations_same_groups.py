"""
Plot all the plants of the same groups
"""
...
for group in group_list :
    ...
    spectra_data_group = spectra_data.copy()
    plants_vibrations = spectra_data_group.copy()
    plants_NOT_vibrations = spectra_data_group.copy()

    # Create dataset with vibrations and not vibrations
